...
def main() -> int:
    ...
    ap.add_argument("--max-time", type=int, default=int(os.environ.get("ELVEX_MAX_TIME", "60")))
    ap.add_argument("--process-timeout", type=int, default=int(os.environ.get("ELVEX_PROCESS_TIMEOUT", "70")))
